                     ...
                     <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card m-card shadow border-0">
                              <div class="m-card-cover">
                                 <img src="assets/img/peliculas/<?php echo $slc_dt_peliculas_lb["imagen"]; ?>" class="card-img-top" alt="...">
                              </div>
                              <div class="card-body p-3">

                                 <h5 class="card-title text-gray-900 mb-1">
                                    <a href="pelicula/<?php echo $slc_dt_peliculas_lb["id"]; ?>"><?php echo $slc_dt_peliculas_lb["titulo"]; ?></a>
                                 ...
                                 <p class="card-text">
                                    ...
                                    <small class="text-muted">
                                       <?php echo $slc_dt_peliculas_lb["sinopsis"]; ?>
                                    </small>
                                 ...
                                 <p class="card-text">
                                    ...
                                    <small class="text-danger">
                                       <?php echo $slc_dt_peliculas_lb["duracion"]; ?>
                                    </small> 
                                    ...
                                    <small class="text-danger">
                                       <?php echo $slc_dt_peliculas_lb["fecha_estreno"]; ?>
                                    </small> 
